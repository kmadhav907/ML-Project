...
test_dir_name = "E:/web/maithli/MLminiproj/TestDigits/"
train_dir_name = "E:/web/maithli/MLminiproj/TrainingDigits/"
...
def ClassifyTest():
    global test_dir_name, train_dir_name
...
def ClassifyTest1(label_s):
    ...
    print(label_s)
    file_content = open(parent_dir+label_s)
    
    label=int(label_s.split('_')[0])
    ...
    result = ClassifyTrain(retval, data_set, label, 3)
    lst=[]
    lst[0]=test_label
    lst[1]=result
    return lst
